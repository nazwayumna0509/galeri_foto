...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Feb 2024 pada 07.39
...
(13, 'Satwa', '                            Hewan-hewan                       ', '2024-02-13', 4),
(14, 'Otomotif', '                Foto seputar otomotif\r\n\r\n                    ', '2024-02-13', 4),
(16, 'Teknologi', '                            Foto Seputar Teknologi                            ', '2024-02-13', 4);
...
(3, 'Mobil Sport', '															Mobil Racing															', '2024-02-22', '1390635967-otomotif.JPG', 14, 4),
(6, 'Komodo', 'Satwa asal indonesia', '2024-02-22', '806002888-komodo.JPG', 13, 4),
(7, 'Teknologi', 'Teknologi', '2024-02-22', '1012589691-digitaltech.jpg', 16, 4);
...
(3, 'tesakun', '7f371e7ec9edec98806ce56a8801dbc8', 'tesakun@gmail.com', 'tesakun', 'tesakun'),
(4, 'Vicky', '020c290593cef84aeac4ea2c269d326d', 'Vicky@Gmail.com', 'Vicky', 'jln.bumi'),
...
ALTER TABLE `komentarfoto`
  ...
  ADD CONSTRAINT `komentarfoto_ibfk_3` FOREIGN KEY (`komentarid`) REFERENCES `komentarfoto` (`fotoid`) ON DELETE CASCADE ON UPDATE CASCADE;
